...
if (isset($_POST['login'])) {
	...
	$sql = "SELECT * FROM tbl_users WHERE email = '" . $email . "' AND matkhau = '" . $matkhau . "' LIMIT 1";
	...
	if ($count > 0) {
		...
		echo '<p style = "color:red; text-align: center;">Tài khoản mật khẩu sai !</p>';
	}
}
?>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form action="" autocomplete="off" method="POST" class="row login_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
